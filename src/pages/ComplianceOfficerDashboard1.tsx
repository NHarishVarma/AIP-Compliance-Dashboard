...
import styles from "./ComplianceOfficerDashboard1.module.css";
const ComplianceOfficerDashboard1: FunctionComponent = () => {
  ...
  return (
    <div className={styles.complianceOfficerDashboard}>
        ...
        <div className={styles.scrollGroup17}>
          <div className={styles.folderExpand2}>
            ...
            <img
              ...
              alt=""
              src="/icon-materialfolderopen.svg"
            />
      ...
      <img
        className={styles.closeFill0Wght300Grad0OpszIcon}
        alt=""
        src="/close-fill0-wght300-grad0-opsz40.svg"
      />
      <b className={styles.whatIsAn}>What is an NDA?</b>
...
export default ComplianceOfficerDashboard1;
