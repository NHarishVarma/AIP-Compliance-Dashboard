...
import styles from "./ComplianceOfficerDashboard4.module.css";
const ComplianceOfficerDashboard4: FunctionComponent = () => {
...
export default ComplianceOfficerDashboard4;
